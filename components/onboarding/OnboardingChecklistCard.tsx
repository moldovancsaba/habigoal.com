      ...
      <Stack gap="sm">
        <Group justify="space-between" align="flex-start">
          <Box>
            <Text fw={700}>
              {module.steps[0]
                ? resolveOnboardingStep(t, messages.Onboarding, module, module.steps[0], "title", t("defaults.checklistTitle"))
                : t("defaults.checklistTitle")}
            </Text>
            <Text size="sm" c="dimmed">
              {module.steps[0]
                ? resolveOnboardingStep(t, messages.Onboarding, module, module.steps[0], "body", t("defaults.checklistBody"))
                : t("defaults.checklistBody")}
            </Text>
          </Box>
          ...
          {module.steps.map((step) => {
            ...
            return (
              <Group key={step.id} gap="sm" wrap="nowrap" align="flex-start">
                ...
                <Box>
                  <Text size="sm" fw={600}>{resolveOnboardingStep(t, messages.Onboarding, module, step, "title", t("defaults.checklistTitle"))}</Text>
                  <Text size="sm" c="dimmed">{resolveOnboardingStep(t, messages.Onboarding, module, step, "body", t("defaults.checklistBody"))}</Text>
                </Box>
              </Group>
            );
          })}
