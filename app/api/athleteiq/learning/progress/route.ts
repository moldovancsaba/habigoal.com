...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.info(JSON.stringify({ capabilityKey: ATHLETEIQ_LITE_GATEWAY_CAPABILITY_KEY, event: "athleteiq.learning_lite.progress_saved", correlationId, athleteId: body.athleteId, latencyMs: Date.now() - startedAt }));
