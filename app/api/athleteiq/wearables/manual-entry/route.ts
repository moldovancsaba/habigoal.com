...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.info(JSON.stringify({ capabilityKey: ATHLETEIQ_LITE_GATEWAY_CAPABILITY_KEY, event: "athleteiq.wearable_manual.entry_saved", correlationId, athleteId: body.athleteId, warnings: result.warnings, latencyMs: Date.now() - startedAt }));
