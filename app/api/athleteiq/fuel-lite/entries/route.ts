...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.info(JSON.stringify({ capabilityKey: ATHLETEIQ_LITE_GATEWAY_CAPABILITY_KEY, event: "athleteiq.fuel_lite.entry_saved", correlationId, athleteIdHash: athleteIqHashForLog(body.athleteId), latencyMs: Date.now() - startedAt }));
