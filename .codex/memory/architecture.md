...
- The athlete daily check-in flow must also be self-scoped in the UI: signed-in athletes should never get a multi-athlete selector or a way to target another athlete profile from the form layer.
