...
- Onboarding copy must be locale-driven from the message catalogs rather than embedded in module definitions, so new role modules inherit the same fail-closed language rules as public news and the rest of the app.
