...
const IDENTICAL_OK = new Set([
  // Backfill residuals: brand/product-OS names, shared loanwords, units,
  // ICU-only strings and file stems that stay identical across locales.
  "Common.emptyValue",
  "Common.languageArabic",
  "Common.languageHebrew",
  "AthleteInsights.sourceType.check_in",
  "AthleteProfileAdmin.position",
  "AthleteProfileAdmin.status",
  "AthleteProfileAdmin.team",
  "AthletesApp.metricCheckIns",
  "AthletesApp.pillarSocial",
  "Common.error",
  "Common.languageEnglish",
  "Common.languageGerman",
  "Common.languageHungarian",
  "Common.languageSpanish",
  "Common.name",
  "Landing.athleteIqBadge",
  "Landing.athleteIqTrainerTitle",
  "Landing.badge",
  "Landing.habigoalBadge",
  "Login.identifierPlaceholder",
  "Login.surfaces.athleteIq.backLink",
  "Login.surfaces.habigoal.backLink",
  "Login.trainerPersonaTitle",
  "News.badge",
  "News.tags.release",
  "PlanningDashboard.loadPoints",
  "ProductSurfaces.athleteIq.athleteWorkspace.recorder.habits.categories.mental",
  "ProductSurfaces.athleteIq.athleteWorkspace.recorder.habits.categories.sport",
  "ProductSurfaces.athleteIq.athleteWorkspace.recorder.habits.itemLabel",
  "ProductSurfaces.athleteIq.athleteWorkspace.recorder.habits.items.hydrate",
  "ProductSurfaces.athleteIq.athleteWorkspace.today.teamLabel",
  "ProductSurfaces.athleteIq.athletes.mentalLabel",
  "ProductSurfaces.athleteIq.controls.mode.lifestyle",
  "ProductSurfaces.athleteIq.controls.role.academy",
  "ProductSurfaces.athleteIq.controls.role.coach",
  "ProductSurfaces.athleteIq.controls.role.services",
  "ProductSurfaces.athleteIq.hero.title",
  "ProductSurfaces.athleteIq.metrics.dailyIq",
  "ProductSurfaces.athleteIq.nav.groups.dailyOs",
  "ProductSurfaces.athleteIq.services.modules.academy-review.owner",
  "ProductSurfaces.athleteIq.services.modules.club-delivery.owner",
  "ProductSurfaces.athleteIq.services.modules.coach-action-queue.owner",
  "ProductSurfaces.athleteIq.services.modules.daily-iq-coverage.owner",
  "ProductSurfaces.athleteIq.services.modules.daily-plan-coverage.owner",
  "ProductSurfaces.athleteIq.services.modules.daily-report.owner",
  "ProductSurfaces.athleteIq.services.modules.session-actions.owner",
  "ProductSurfaces.athleteIq.services.modules.team-roster-coverage.owner",
  "ProductSurfaces.athleteIq.surfaceName",
  "ProductSurfaces.athleteIq.theme.name",
  "ProductSurfaces.common.state.neutral",
  "ProductSurfaces.habigoal.badges.checkIn",
  "ProductSurfaces.habigoal.habits.categories.mental",
  "ProductSurfaces.habigoal.habits.categories.sport",
  "ProductSurfaces.habigoal.habits.itemLabel",
  "ProductSurfaces.habigoal.habits.items.hydrate",
  "ProductSurfaces.habigoal.scorePending",
  "ProductSurfaces.habigoal.surfaceName",
  "ProductSurfaces.syncLabel",
  "Report.booleanNo",
  "Report.coachPriorityPillar",
  "Report.fileStem",
  "Report.pillarTableDelta",
  "SessionRunner.pause",
  "TeamInvitations.emailPlaceholder",
  "TeamInvitations.roleTrainer",
  "TeamInvitations.teamLabel",
  "Wearables.metricLabel.hrv_rmssd_ms",
  "Wearables.providers.apple_health.name",
  "Wearables.providers.garmin.name",
  "Wearables.providers.oura.name",
  "Wearables.providers.polar.name",
  "Wearables.providers.whoop.name",
  "Wearables.status.error",
